...
class Settings(BaseSettings):
    ...
    gemini_api_key: str = ""
    llm_model_name: str = "gemini-1.5-flash-8b"  # Lightest model, highest free quota
    llm_temperature: float = 0.2
    llm_max_tokens: int = 2048

    # Embedding Configuration
    embedding_model_name: str = "sentence-transformers/all-MiniLM-L6-v2"  # Lighter embedding model
